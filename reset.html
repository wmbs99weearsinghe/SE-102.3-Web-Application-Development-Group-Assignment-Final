...
<div style="background-color: #3598dc; ">
 ...
 <div class="login-form">
  <h1>Hotel Name</h1>
  <!--<form action="/examples/actions/confirmation.php" method="post" class="needs-validations" > -->
    <form action="/examples/actions/confirmation.php" method="post" class="needs-validation" novalidate>
      <h3 class="text-center">Forgot your password?</h3>  
      <p>Enter your inputEmail and we’ll help you reset your password.</p>
